        ...
        <div class="card-body px-0 pb-2">
          <div class="table-responsive">
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Top</th>
              ...
              <tbody>
                ...
                <tr>
                  <td class="align-middle text-sm">
                    <span class="text-xs font-weight-bold"> {{ $topIndex++ }} </span>
                  </td>
                  <td>
                    <div class="d-flex px-2 py-1">
                      <div>
                        <img src="{{ $buyer->avatar }}" class="avatar avatar-sm me-3">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">{{ $buyer->username }}</h6>
                      </div>
                    </div>
                  </td>
                  <td class="align-middle text-center text-sm">
                    <span class="text-xs font-weight-bold">{{ $buyer->total }} VND</span>
                  </td>
                </tr>
                @endforeach
              </tbody>
