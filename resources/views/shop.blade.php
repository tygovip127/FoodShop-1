@extends('layouts.app')
@section('title','Food Shop VKU | Shop')

@section('content')
<x-breadcrumb currentPage="Shop"></x-breadcrumb>
                        ...
                        <div class="shop-bottom-area">
                            <div class="tab-content jump">
                                <div id="shop-1" class="tab-pane active">
                                    <div class="row">
                                        <x-shop-simple-card title="Basic Joggin Shorts" price="20.50" discount="0" image="images/products/product-1.jpg" link="product-details.html"></x-shop-simple-card>
                                        <x-shop-simple-card title="Make Thing Happen T-Shirt" price="45.80" discount="20" image="images/products/product-1.jpg" link="product-details.html"></x-shop-simple-card>  
                                    </div>
                                </div>
                            </div>
